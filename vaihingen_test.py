...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, default=r'config/vaihingen/config.py', help="Path to config")
    arg("-o", "--output_path", type=Path, default=r'fig_results/vaihingen/out', help="Path where to save resulting masks.")
